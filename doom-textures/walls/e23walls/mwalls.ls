$load mwall1.lbm
mwall1_1                PATCH255        16      16      128 128
mwall1_2                PATCH255        152 16 128 128

$load mwall2.lbm
mwall2_1                PATCH255        16      16      128 128
;	mwall2_2                PATCH255        152 16 128 128

$load mwall3.lbm
mwall3_1                PATCH255        16      16      128 128
;	mwall3_2                PATCH255        152 16 128 128

$load mwall4.lbm
mwall4_1                PATCH255        16      16      128 128
mwall4_2                PATCH255        152     16      128 128

$load mwall5.lbm
mwall5_1                PATCH255        16      16      128     128

; MOVED FROM E1
$load ../e1walls/t14.lbm
t14_3		patch255	168 24  64  72

$load ../e1walls/crates.lbm
